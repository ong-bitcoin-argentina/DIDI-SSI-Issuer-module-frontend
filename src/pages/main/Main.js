...
import Templates from "./components/templates/list/Templates";
import TemplateTableHelper from "./components/templates/list/TemplateTableHelper";

import Presentation from "./components/presentations/list/Presentations";
import Response from "./components/responses/list/Responses";

import Certificates from "./components/certificates/list/Certificates";
import CertificateTableHelper from "./components/certificates/list/CertificateTableHelper";

import ParticipantsTableHelper from "./components/participants/ParticipantsTableHelper";
...
import DelegatesTableHelper from "./components/administrative/list/DelegatesTableHelper";

import InputDialog from "../../utils/dialogs/InputDialog";

import CertificatesEmmited from "./components/certificates/emmited/CertificatesEmmited";
import CertificatesRevoked from "./components/certificates/revoked/CertificatesRevoked";
import Header from "../../components/Header";
import UserList from "./components/users/user-list";
import Setting from "./components/setting/setting";
import { validateAccess } from "../../utils/constants/Roles";
import Profile from "./components/profile/profile";
import Delegates from "./components/administrative/list/Delegates";
